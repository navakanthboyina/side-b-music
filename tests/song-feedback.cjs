...
w.eval(fs.readFileSync(root+'data.js','utf8'));w.eval(fs.readFileSync(root+'app.js','utf8').replaceAll("import('./ai-client.mjs')","Promise.resolve(window.__client)").replaceAll("import('./ai-core.mjs')","Promise.resolve(window.__core)"));
return {dom,w,d};}
