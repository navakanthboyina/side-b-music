...
export async function recommend(profile, progress, signal) {
  ...
  try {
    return await new Promise((resolve,reject)=>{
      ...
      try {
        worker ||= new Worker(new URL('./ai-worker.mjs?v=labels-fix-1',import.meta.url),{type:'module'});
...
export async function clearDownloads(){
 ...
 try{
  await new Promise((resolve,reject)=>{
   ...
   try{
    cleanupWorker=new Worker(new URL('./ai-worker.mjs?v=labels-fix-1',import.meta.url),{type:'module'});
